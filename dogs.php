...
<html lang="en">
    <head>
	<title>DOGS-Skylar's Oragnization</title>
    ...
    <body style="color: #003366; top: 0;">
        <div style="margin-top: -55px;">
        <center>
            
            <a href="index.php"><img src="images/logo11.jpeg" 
			style="margin-left: -1125px;
			height: 255px; width: 265px; border: 5px solid #00CCFF; box-shadow: 0 0 20px 0px rgba(0,0,0,0.1);
            cursor: pointer;  margin-top: 35px; margin-bottom: 57px; float: top; "></a>
 ...
 <!---container1--->	
	 ...
	 style="background-color: #fff; width: 350px; height: 510px; display: inline; margin-left: 367px;float: right; margin-top: -510px;">
                      ...
                      <h2>BREED: &nbspSHIH TZU</h2>
                      <br><br>
                      <p>AGE: 2 MONTHS<BR> SIBLINGS: 0<br>GENDER: MALE<BR>JOIN DATE: 15th SEPTEMBER,2019<BR>CITY: DOMBIVLI</p>
                      <BR>
                      <h3 style="color: #006666;">STATUS: AVAILABLE</h3>
					  <br>
                      <BUTTON name="submit" onclick="passvalues();" style="width: 155px; color: #FFF;
