...
<html>
 <head>
   <title>PET SUPPLIES CART-SKYLAR</title>
   <link rel="stylesheet" href="Styles/stylecart.css" media="all"></link>
  ...
  <body>
	...
	<div class="row">
	<div class="col-2">
	 <h1 style="color: #003366;">MY CART</h1>
	 </div>
  ...
  $random=(rand(10,1000));
	 ...
	 <form action="orderdetails.php" method="post">
	  <font size="24px"><BUTTON name="submit" style="width: 265px; color: #FFF; height: 93px;
								...
								cursor: pointer;">PAY NOW!&nbsp<i class="fa fa-arrow-right"></i></BUTTON></font>
	 </form>
