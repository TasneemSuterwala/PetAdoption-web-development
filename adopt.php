...
<div class="account-page">
    <div class="container">
	  <div class="row">
	    <div class="col">
		<h1>SKYLAR'S ADOPTION ORGANIZATION </h1>
		<hr><br>
		    <form id="DonationForm" action="adoptionbackend.php" method="POST">
			
			<div class="formcontainer">
		     <label><b>Breed Of Adoption</b></label>
		   <br><input type="text" name="breed" value="" placeholder="" id="mytext" class="form-control" required>
		  </div>
  ...
  <option value="9:00am-11:00am">7:00am-11:00am</option>
  <option value="2:30pm-4:30pm">2:30pm-6:30pm</option>
  <option value="5:30pm-8:00pm">8:30pm-10:00pm</option>
</select>
		  </div>
		  
		  <button type="submit" name="submit" class="btn">Adopt Now!&nbsp <i class="fas fa-angle-double-right"></i></button>
