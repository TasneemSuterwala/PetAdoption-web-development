...
<head>
    <meta charset="UTF-8">
   <title>Skylar's Adoption Organization-Appointment Confirmation</title>
...
<body>
 <section id="banner">
	...
	<div class="confirmation">
		<br>
		<br>
	<center><img src="images/appointment.png" width="227px" height="247px" style="margin-top: 129px;"><center>
	</div>
	
	<font size="6px" color="#ff005c" align="center" face="Josefin Sans"><h1>THANK YOU!</h1></font>
	
	<font size="5px" color="#8f4f4f" align="center"><h3>Your Appointment has been Confirmed.</h3></font>
